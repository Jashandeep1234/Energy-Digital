  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none -z-10">
      ...
      <motion.div 
        ...
        className="absolute -top-[20%] -left-[10%] w-[70%] h-[70%] bg-cyan-500/10 blur-[120px] rounded-full"
      />
      <motion.div 
        animate={{ 
          opacity: [0.2, 0.4, 0.2],
        ...
        className="absolute -bottom-[20%] -right-[10%] w-[70%] h-[70%] bg-blue-600/10 blur-[120px] rounded-full"
      />

      {/* React Bits Style Light Rays */}
        ...
        <div className="relative w-full h-full">
          {[...Array(6)].map((_, i) => (
            <motion.div
              ...
              className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[200%] h-[100px] bg-gradient-to-r from-transparent via-cyan-500/10 to-transparent blur-3xl origin-center"
            />
          ))}
...
export const DigitalTwin = ({ data, onBuildingClick }: any) => (
    <div className="w-full h-full min-h-[500px] relative rounded-3xl overflow-hidden bg-black group/scene">
    ...
    <div className="absolute top-4 sm:top-8 left-4 sm:left-8 space-y-3 sm:space-y-4 pointer-events-none z-10">
      <div className="flex items-center gap-2 sm:gap-3">
        <div className="h-2 w-2 rounded-full bg-blue-500 shadow-[0_0_8px_#3b82f6]" />
        <h3 className="text-xs sm:text-sm font-black text-white/90 tracking-[0.3em] sm:tracking-[0.4em] uppercase">Campus_Nexus_Core</h3>
      </div>
    ...
    <div className="absolute bottom-4 sm:bottom-8 right-4 sm:right-8 flex flex-col gap-2 sm:gap-3 p-3 sm:p-6 rounded-xl sm:rounded-[2rem] bg-black/60 border border-white/5 backdrop-blur-3xl min-w-[200px] sm:min-w-[240px] z-10">
